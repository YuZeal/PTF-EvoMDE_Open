...
model = dict(
    type='NASRetinaNet',
    pretrained=dict(
        # use_load=False,  # 是否启用FNA
        # load_path='/data/code_yzh/FNA_EC/fna_depth/log/output_20241108-103151_search_imagenet/supernet.pth',  # use_load=False时，会直接加载load_path权重（不经过FNA）
        use_load=True,
